...
class WhatsAppClient {
    ...
    async handleTTSRequest(msg) {
        ...
        const prompt = this.promptService.generateSpeechPrompt(config.ttsPrefix + speechText);
    ...
    async handleImageRequest(msg) {
        ...
        try {
            const prompt = this.promptService.generateImagePrompt(config.imagePromptPrefix + msg.body);
            const imgres = await this.gptService.getResponse(prompt, config.systemImagePrompt);
