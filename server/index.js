 ...
 */
const initializeWhatsAppClient = ({ gptService, bingService, ttsService, promptService }) => {
...
const handleError = async (error) => {
    ...
    setTimeout(function(){process.exit(1)}, 2e3) // Exit the process with status code 1
};
